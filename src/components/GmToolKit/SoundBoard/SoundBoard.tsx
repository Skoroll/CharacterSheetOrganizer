...
const musicThemes: SoundLibrary = {
  Calme: ["", "/sounds/calm2.mp3", "/sounds/calm2.mp3"],
  Combat: [
    "/sounds/music/battle-of-the-dragons-8037.mp3",
    "/sounds/combat2.mp3",
  ],
  ...
  return (
    <div className="gm-tool soundboard">
      <div className="soundboard__theme-bar">
        ...
        {openTheme && musicThemes[openTheme] && (
          <div className="soundboard__tracks">
            {musicThemes[openTheme].map((track: string, index: number) => (
        ...
        {openTheme && soundScape[openTheme] && (
          <div className="soundboard__tracks">
            {soundScape[openTheme].map((track: string, index: number) => (
